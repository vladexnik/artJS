const modals=()=>{
    ...
    function bindModal(triggerSelector, modalSelector, closeSelector, destroy=false ){
        ...
        trigger.forEach(item => 
            item.addEventListener('click', (e)=>{
                ...
                windows.forEach(item=>{ // закрываем все модалки возможные
    ...
    function openByScroll(selector){
        window.addEventListener('scroll',()=>{
            ...
            let scrollHeight=Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // для старых браузеров Режим совместимости
